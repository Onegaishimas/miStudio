            ...
            <div className="space-y-3">
              ...
              {extractions.map((extraction) => (
                <div
                  ...
                  className={`bg-slate-100 dark:bg-slate-800/50 border rounded-lg p-4 transition-colors ${
                ...
                >
                  <div className="flex items-start justify-between gap-3">
                    ...
                    <input
                      ...
                      className="w-5 h-5 rounded border-slate-300 dark:border-slate-600 bg-white dark:bg-slate-800 text-emerald-600 focus:ring-emerald-500 focus:ring-offset-white dark:focus:ring-offset-slate-900 cursor-pointer mt-0.5 flex-shrink-0"
                    />
                    ...
                    <div className="flex-1 min-w-0 cursor-pointer" onClick={() => onSelectExtraction(extraction)}>
                      ...
                      {/* Model + Dataset + Split */}
                      <div className="flex items-center gap-2 mb-1 text-xs text-slate-700 dark:text-slate-300">
