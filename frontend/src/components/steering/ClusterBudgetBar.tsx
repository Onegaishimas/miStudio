...
const FLAG_COPY: Record<string, string> = {
  ...
  low_cohesion: 'Low cluster cohesion — solo baselines kept (budget shown for reference)',
...
export function ClusterBudgetBar() {
  const { clusterBudget, selectedFeatures } = useSteeringStore();
  if (!clusterBudget) return null;
