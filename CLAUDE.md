...
- **Active Work (prior):** None. Next natural step: follow-on BRD (MILLM import / unified MCP / Open WebUI / HF-marketplace publishing — research ready at `0xcc/docs/hf-marketplace-cluster-definitions-research.md`)
